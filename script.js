    ...
    try {
        ...
        console.error('Error:', error);
            ...
            function renderFoods(foods) {
                ...
                foods.forEach((food, index) => {
                    ...
                    if (food.imageUrl) {
                        ...
                        imageSrc = `https://redox-resto.onrender.com/foods/${food._id}/image`; // Local stored image
                    } else {
            ...
            async function showOrderStatus() {
                try {
                    const response = await fetch('https://redox-resto.onrender.com/orders/latest');
                    const data = await response.json();
            ...
            function renderOrderStatus(order) {
                ...
                order.foodItems.forEach(item => {
                    ...
                    orderItem.innerHTML = `
                        <img src="https://redox-resto.onrender.com/foods/${item.foodId}/image" alt="${item.name}" class="order-item-image">
